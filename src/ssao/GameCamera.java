...
public class GameCamera {
	public enum GameCameraMode {
		GAMECAM_TARGETED, GAMECAM_FIRST_PERSON, GAMECAM_ORBIT
	};
	...
	private FloatBuffer matBuffProjection = BufferUtils
	...
	public Vec3 getOrientationUp() {
		return orientationUp;
	}

	public void setOrientationUp(Vec3 orientationUp) {
	...
	public Mat4 getMatProjection() {
		return matProjection;
	}

	public void setMatProjection(Mat4 matProjection) {
	...
	public void setMatView(Mat4 matView) {
	...
	public void setMatVP(Mat4 matVP) {
		this.matVP = matVP;
	}

	public FloatBuffer getMatBuffProjection() {
		return matBuffProjection;
	}

	public void setMatBuffProjection(FloatBuffer matBuffProjection) {
		this.matBuffProjection = matBuffProjection;
	}

	public FloatBuffer getMatBuffView() {
		return matBuffView;
	}

	public void setMatBuffView(FloatBuffer matBuffView) {
		this.matBuffView = matBuffView;
	}
	...
	public void setMatBuffVP(FloatBuffer matBuffVP) {
		this.matBuffVP = matBuffVP;
	}
